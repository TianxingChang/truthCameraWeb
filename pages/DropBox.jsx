...
function DropBox() {
  ...
  async function handleUploadInner() {
    ...
    const upUrl =
      "http://20.24.98.15:5000/verify_img?pic_hash=" + '"' + uploadHash + '"';
  ...
  */
  ...
  function renderText(textColor) {
    return <p style={{ color: textColor }}>{boxText}</p>;
  }
  ...
  function renderBackground(background) {
    return (
      <DropzoneContainer
        className={dropzoneStyle.DropzoneContainer}
        {...getRootProps()}
      >
        <input {...getInputProps()} />
    ...
    <>
      ...
      <div>
        <Button
          ...
          style={{
            color: "rgb(47,110,235)",
            borderColor: isHover ? "rgb(47,110,235)" : "",
          }}
